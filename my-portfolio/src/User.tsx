...
const SkillInfo = [
    {
        title: "Frontend",
        skills: ["HTML", "CSS", "JavaScript", "React JS", "Angular", "Redux", "Tailwind CSS", "Material UI", "Bootstrap"
        ]
    },
    {
        title: "Backend",
...
const socialLinks = [
    { link: "https://github.com/sathwikdatta", icon: IconBrandGithub },
    { link: "https://www.linkedin.com/in/dosetti-sathwik-datta/", icon: IconBrandLinkedin }
];
